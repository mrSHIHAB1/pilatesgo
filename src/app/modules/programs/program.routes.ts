...
import {
  ...
  getMyProgramSnapshot,
  setSnapshotItemDoneForMe,
...
router.get('/my-challenges/today', auth(),  getMyTodaysChallenges);
router.get('/my-challenges/upcoming', auth(),  getMyUpcomingChallenges);
...
router.get('/:programId/snapshot', auth(),  getMyProgramSnapshot);
router.patch('/:programId/snapshot/weeks/:snapshotWeekId/days/:snapshotDayId/items/:snapshotItemId', auth(), setSnapshotItemDoneForMe);
router.patch('/:programId/weeks/:programWeekId/days/:programDayId/done', auth(),  validateRequest(setExerciseDoneValidation), setExerciseDoneForMe);
